...
const MenuPdf = () => {
  ...
  const openPdfInNewTab = () => {
    window.open('/menu_pdf.pdf', '_blank');
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-4 sm:py-6">
        {isMobile ? (
          /* Mobile View - показываем кнопки для открытия PDF */
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="bg-white rounded-2xl shadow-xl overflow-hidden"
          >
            {/* Embedded PDF for mobile with special settings */}
            <div className="relative" style={{ height: 'calc(100vh - 160px)' }}>
              ...
              {/* Object tag works better on mobile than iframe */}
              <object
                data="/menu_pdf.pdf#view=FitH&toolbar=0&navpanes=0&scrollbar=1"
          ...
          /* Desktop View - iframe with full PDF */
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <iframe
              id="pdf-viewer"
              src="/menu_pdf.pdf#view=FitH&toolbar=1&navpanes=0"
